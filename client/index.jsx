...
import { Homepage, Main, Chapter1, Chapter2, Chapter3, Chapter4, Chapter5, Chapter6, NotFound } from './components';
    ...
    <ScrollToTop>
      <Main>
        <Switch>
          ...
          <Route path="/chapter-6" component={() => <Chapter6 title="Financial Ratios" />} />
