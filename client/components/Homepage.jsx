...
export default () => (
  <div className="tc mt5 pt4 mh3">
    <h1 className="h2 mt2 mb5 mb4-ns">Financial Foundations</h1>
    <div className="dib h2 bg-light-purple slider slider-container">

      <span className="h2 w-25 bg-light-silver fr slider">
      ...
      <span className="h2 w-25 bg-green fr slider">
      ...
      <span className="h2 w-25 bg-gold fr slider">
      ...
      <span className="h1 w-25 bg-near-white fl" />
      <h2 className="white mt5">Get in touch</h2>
    </div>
